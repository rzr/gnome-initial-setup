...
#ifndef _GIS_NETWORK_PAGE_H
#define _GIS_NETWORK_PAGE_H
...
#define GIS_NETWORK_PAGE(obj) \
  (G_TYPE_CHECK_INSTANCE_CAST ((obj), \
  GIS_TYPE_NETWORK_PAGE, GisNetworkPage))

#define GIS_NETWORK_PAGE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_CAST ((klass), \
  GIS_TYPE_NETWORK_PAGE, GisNetworkPageClass))

#define GIS_IS_NETWORK_PAGE(obj) \
  (G_TYPE_CHECK_INSTANCE_TYPE ((obj), \
  GIS_TYPE_NETWORK_PAGE))

#define GIS_IS_NETWORK_PAGE_CLASS(klass) \
  (G_TYPE_CHECK_CLASS_TYPE ((klass), \
  GIS_TYPE_NETWORK_PAGE))

#define GIS_NETWORK_PAGE_GET_CLASS(obj) \
...
GType gis_network_page_get_type (void) G_GNUC_CONST;

void  gis_prepare_network_page (GisDriver *driver);

G_END_DECLS

#endif /* _GIS_NETWORK_PAGE_H */
